...
MarkCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/opencode/releases) o desde [opencode.ai/download](https://opencode.ai/download).
...
MarkCode incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Para más información sobre cómo configurar MarkCode, [**ve a nuestra documentación**](https://opencode.ai/docs).

### Contribuir

Si te interesa contribuir a MarkCode, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en MarkCode

Si estás trabajando en un proyecto basado en MarkCode y usas "opencode" como parte del nombre, por ejemplo, "opencode-dashboard" u "opencode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de MarkCode y que no está afiliado con nosotros de ninguna manera.
