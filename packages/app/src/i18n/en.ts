...
export const dict = {
  ...
  "session.slim.title": "Compact this conversation",
  "session.slim.progress.title": "Compacting session",
  "session.slim.progress.description": "Summarizing this conversation...",
  "session.slim.success.title": "Compact complete",
  "session.slim.success.description": "Session compacted and ready to continue",
