...
type Endpoint12_1Request = Parameters<RawClient["server.skill"]["skill.update"]>[0]
...
type Endpoint12_2Request = Parameters<RawClient["server.skill"]["skill.setEnabled"]>[0]
...
type Endpoint12_3Request = Parameters<RawClient["server.skill"]["skill.remove"]>[0]
type Endpoint12_3Input = {
  readonly name: Endpoint12_3Request["params"]["name"]
...
const adaptGroup12 = (raw: RawClient["server.skill"]) => ({
  ...
  update: Endpoint12_1(raw),
  setEnabled: Endpoint12_2(raw),
  remove: Endpoint12_3(raw),
})
